...
📖 **[Read the guide](https://alejtraws.github.io/agentic-engineering-framework/)** · 🗂️ **[Pick a sample](#samples)** · 🛠️ **[Customize the layer](#the-agentic-layer-what-you-customize)**

[![License: MIT-0](https://img.shields.io/badge/License-MIT--0-blue.svg)](./LICENSE)
[![AWS Samples](https://img.shields.io/badge/AWS-Samples-232F3E?logo=amazon-aws)](https://github.com/aws-samples)
[![Last commit](https://img.shields.io/github/last-commit/alejtraws/agentic-engineering-framework)](https://github.com/alejtraws/agentic-engineering-framework/commits)
...
|---|---|---|---|---|
| [`human-in-loop`](https://github.com/aws-samples/sample-agentic-engineering-framework/tree/main/human-in-loop) | L1 Assisted | Markdown checklists | Any agent | Learning the AEF patterns by hand |
| [`automated-kiro`](https://github.com/aws-samples/sample-agentic-engineering-framework/tree/main/automated-kiro) | L1–L4 capable | Declarative YAML + engine | Kiro CLI | Running AEF autonomously, configurable per team |
| [`sprint-runner`](https://github.com/aws-samples/sample-agentic-engineering-framework/tree/main/sprint-runner) | L3 Autonomous | Imperative Python + per-sprint state | Kiro CLI or Claude Code CLI | Installing AEF into existing repos; sprint-batch delivery with crash-resumable runs |
...
|---|---|---|
| Human-in-loop | [`human-in-loop/kiro/`](https://github.com/aws-samples/sample-agentic-engineering-framework/tree/main/human-in-loop/kiro) | [`human-in-loop/claude/`](https://github.com/aws-samples/sample-agentic-engineering-framework/tree/main/human-in-loop/claude) |
| Sprint runner | [`sprint-runner/kiro/`](https://github.com/aws-samples/sample-agentic-engineering-framework/tree/main/sprint-runner/kiro) | [`sprint-runner/claude/`](https://github.com/aws-samples/sample-agentic-engineering-framework/tree/main/sprint-runner/claude) |
| Automated | [`automated-kiro/`](https://github.com/aws-samples/sample-agentic-engineering-framework/tree/main/automated-kiro) | — |
| Primitive agents | [`agent-samples/`](https://github.com/aws-samples/sample-agentic-engineering-framework/tree/main/agent-samples) (tech-agnostic) | |
...
Agent configs for the Kiro variant live in [`agent-samples/`](https://github.com/aws-samples/sample-agentic-engineering-framework/tree/main/agent-samples): six generic configs (plan, build, test, review, document, deploy) with matching prompt templates. The Claude variant ships its own `prompts/` and `agents/` folders; copy them into `.claude/commands/` and `.claude/agents/` instead.

See [`human-in-loop/README.md`](https://github.com/aws-samples/sample-agentic-engineering-framework/blob/main/human-in-loop/README.md) for the pattern overview and per-tech READMEs for the phase-by-phase flow.
...
See [`automated-kiro/README.md`](https://github.com/aws-samples/sample-agentic-engineering-framework/blob/main/automated-kiro/README.md) for the full configuration reference.
...
See [`sprint-runner/README.md`](https://github.com/aws-samples/sample-agentic-engineering-framework/blob/main/sprint-runner/README.md) for the pattern overview and per-tech READMEs for the full stage reference and installer/runner CLI details.
